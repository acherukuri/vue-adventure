      ...
      <div class="column is-8">
        <div class="card edit-detail">
              ...
              <div class="field">
                <label for="power">
                  ...
                  <div class="select is-primary">
                    <select id="power" v-model="hero.power" @keyup.esc="clearPower" v-bind:class="{invalid: !hero.power }">
          ...
          <footer class="card-footer">
            <button class="link card-footer-item cancel-button" v-on:click="clearMessage">
              <i class="fas fa-undo"></i>
              <span>Cancel</span>
            </button>
            <button class="link card-footer-item" v-on:click="saveMessage">
